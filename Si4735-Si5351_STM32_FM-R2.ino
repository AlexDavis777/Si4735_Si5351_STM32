...
void stepCheck() {
  if (digitalRead(button2) == LOW && (fstep == 100000)) {
	fstep = 1000000;
	steps = "1MHz";
	delay (300);
	}
  if (digitalRead(button2) == LOW && (fstep == 1000000)) {
   fstep = 100;
    steps = "100Hz";
    delay (300);
  }
    if (digitalRead(button2) == LOW && (fstep == 100)) {
   fstep = 1000;
    steps = "1kHz";
    delay (300);
  }
    if (digitalRead(button2) == LOW && (fstep == 1000)) {
   fstep = 10000;
    steps = "10kHz";
    delay (300);
  }
